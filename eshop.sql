...
INSERT INTO `address` (`id`, `street`, `city`, `state_id`) VALUES
(1, 'jenini street', 'jetpur', 12),
(2, 'Brisbane 304  ', 'Brisbane', 248),
(3, 'Perth  208', 'Perth', 250),
(4, 'Marine drive', 'Mumbai', 22),
(5, 'Colaba Causeway', 'Mumbai', 22),
(10, 'wewe', 'wewe', NULL),
(11, 'wewe', 'sdf', NULL),
(14, '1111111', '1111111', 419),
(15, '11111', '1', 351),
(16, 'LDRP', 'GANDHINAGAR', 12),
(17, 'LDRP', 'GANDHINAGAR', 12),
(18, 'lalvadi', 'pune', 1350),
(19, 'lalvadi', 'pune', 12),
(20, 'bsnl office', 'Jamjodhapur', 12),
(21, 'a no-20 ', 'baroda', 12),
(22, 'cristal mall', 'jamnagar', 12),
(23, 'kh-5', 'GANDHINAGAR', 12),
(24, 'revdi vadi', 'rajkot', 12),
(25, 'revdi vadi', 'rajkot', 1600),
(26, 'JEMINI', 'JETPUR', 12),
(27, 'LDRP', 'GANDHINAGAR', 171),
(28, 'bsnl office', 'Jamjodhapur', 12),
(29, 'LDRP', 'GANDHINAGAR', 12),
(30, 'bsnl office', 'JETPUR', 198),
(31, 'JEMINI', 'GANDHINAGAR', 288);
...
INSERT INTO `attributes_options` (`id`, `attribute_id`, `value`) VALUES
(1, 1, 'XXS'),
(2, 1, 'XS\r\n'),
(3, 1, 'S\r\n'),
(4, 1, 'M'),
...
INSERT INTO `item` (`id`, `name`, `sku`, `category_id`, `price`, `qty`, `color_id`, `is_trending`, `short_desc`, `description`, `delivery_desc`, `shipping_desc`, `sizeguide_desc`) VALUES
(1, 'U.S. Polo Assn. Full Sleeve Plain T-Shirts for Men\n', 'mag209_prod1', 4, 120, 1, 9, 1, 'Lorem Ipsum Dolor Sit Amet, Consectetur Adipiscing Elit. Sed At Ante. Mauris Eleifend, Quam A Vulputate Dictum, Massa Quam Dapibus Leo, Eget Vulputate Orci Purus Ut Lorem. In Fringilla Mi In Ligula. Pellentesque Aliquam Quam Vel Dolor. Every Item Is A Vital Part Of A Woman''s Wardrobe.\r\n', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed at ante. Mauris eleifend, quam a vulputate dictum, massa quam dapibus leo, eget vulputate orci purus ut lorem. In fringilla mi in ligula. Pellentesque aliquam quam vel dolor. Nunc adipiscing. Sed quam odio, tempus ac, aliquam molestie, varius ac, tellus. Vestibulum ut nulla aliquam risus rutrum interdum. Pellentesque lorem. Curabitur sit amet erat quis risus feugiat viverra. Pellentesque augue justo, sagittis et, lacinia at, venenatis non, arcu. Nunc nec libero. In cursus dictum risus. Etiam tristique nisl a\r\n', 'We offer the following delivery options for 24c ours over the world. Deliveries are not made on Saturdays, Sundays or on public holidays. A specific time slot cannot be specified with any of our delivery options. Please refer to the Terms and Conditions of Sale.\r\n', 'Before we can dispatch your purchases, we may need to confirm your details with your card issuer. We will do our best to keep delays to a minimum Our delivery time starts from the moment an order is accepted and includes a 48 hour period where your items will be processed and dispatched by our warehouse\r\n', '<table class="table detail_table"><thead  class="detail_table_bg"><tr><th>Size</th><th>S</th><th>M</th><th>L</th><th>XL</th></tr></thead><tbody><tr><td>Men</td><td>7-10</td><td>10-13</td><td>13-15</td><td>15-17</td></tr><tr><td>Women</td><td>7-9</td><td>10-12</td><td>13-14</td><td>15-16</td></tr></tbody></table>\r\n'),
(2, 'U.S. Polo Assn. Full Sleeve Plain T-Shirts for Men', 'maks_fgj', 1, 29, 6, 10, 1, 'Trendy, funny, or just plain crazy, our men''s novelty socks let your personality shine through. Find anything from sharks to beer socks in our collection.', 'Trendy, funny, or just plain crazy, our men''s novelty socks let your personality shine through. Find anything from sharks to beer socks in our collection.', 'Trendy, funny, or just plain crazy, our men''s novelty socks let your personality shine through. Find anything from sharks to beer socks in our collection.', 'Trendy, funny, or just plain crazy, our men''s novelty socks let your personality shine through. Find anything from sharks to beer socks in our collection.', '<table class="table detail_table"><thead  class="detail_table_bg"><tr><th>Size</th><th>S</th><th>M</th><th>L</th><th>XL</th></tr></thead><tbody><tr><td>Men</td><td>7-10</td><td>10-13</td><td>13-15</td><td>15-17</td></tr><tr><td>Women</td><td>7-9</td><td>10-12</td><td>13-14</td><td>15-16</td></tr></tbody></table>'),
(3, 'U.S. Polo Assn. Full Sleeve Plain T-Shirts for Men', 'sdfd', 8, 19, 9, 11, 1, 'Trendy, funny, or just plain crazy, our men''s novelty socks let your personality shine through. Find anything from sharks to beer socks in our collection.', 'Trendy, funny, or just plain crazy, our men''s novelty socks let your personality shine through. Find anything from sharks to beer socks in our collection.', 'Trendy, funny, or just plain crazy, our men''s novelty socks let your personality shine through. Find anything from sharks to beer socks in our collection.', 'Trendy, funny, or just plain crazy, our men''s novelty socks let your personality shine through. Find anything from sharks to beer socks in our collection.', '<table class="table detail_table"><thead  class="detail_table_bg"><tr><th>Size</th><th>S</th><th>M</th><th>L</th><th>XL</th></tr></thead><tbody><tr><td>Men</td><td>7-10</td><td>10-13</td><td>13-15</td><td>15-17</td></tr><tr><td>Women</td><td>7-9</td><td>10-12</td><td>13-14</td><td>15-16</td></tr></tbody></table>'),
(4, 'U.S. Polo Assn. Full Sleeve Plain T-Shirts for Men', 'sds', 8, 3500, 8, 12, 0, 'Trendy, funny, or just plain crazy, our men''s novelty socks let your personality shine through. Find anything from sharks to beer socks in our collection.', 'Trendy, funny, or just plain crazy, our men''s novelty socks let your personality shine through. Find anything from sharks to beer socks in our collection.', 'Trendy, funny, or just plain crazy, our men''s novelty socks let your personality shine through. Find anything from sharks to beer socks in our collection.', 'Trendy, funny, or just plain crazy, our men''s novelty socks let your personality shine through. Find anything from sharks to beer socks in our collection.', '<table class="table detail_table"><thead  class="detail_table_bg"><tr><th>Size</th><th>S</th><th>M</th><th>L</th><th>XL</th></tr></thead><tbody><tr><td>Men</td><td>7-10</td><td>10-13</td><td>13-15</td><td>15-17</td></tr><tr><td>Women</td><td>7-9</td><td>10-12</td><td>13-14</td><td>15-16</td></tr></tbody></table>'),
(5, 'U.S. Polo Assn. Full Sleeve Plain T-Shirts for Men', 'sdsds', 1, 5000, 4, 13, 0, 'Shop for a variety of International Men''s watches, International Women''s watches, International Boys'' watches, International Girl''s watches and many more to tend to your fashion needs', 'Shop for a variety of International Men''s watches, International Women''s watches, International Boys'' watches, International Girl''s watches and many more to tend to your fashion needs', 'Shop for a variety of International Men''s watches, International Women''s watches, International Boys'' watches, International Girl''s watches and many more to tend to your fashion needs', 'Shop for a variety of International Men''s watches, International Women''s watches, International Boys'' watches, International Girl''s watches and many more to tend to your fashion needs', '<table class="table detail_table"><thead  class="detail_table_bg"><tr><th>Size</th><th>S</th><th>M</th><th>L</th><th>XL</th></tr></thead><tbody><tr><td>Men</td><td>7-10</td><td>10-13</td><td>13-15</td><td>15-17</td></tr><tr><td>Women</td><td>7-9</td><td>10-12</td><td>13-14</td><td>15-16</td></tr></tbody></table>'),
(6, 'U.S. Polo Assn. Full Sleeve Plain T-Shirts for Men', 'sddf', 1, 1500, 7, 14, 1, 'Shop for latest styles from our wide range of collection', 'Shop for latest styles from our wide range of collection', 'Shop for latest styles from our wide range of collection', 'Shop for latest styles from our wide range of collection', '<table class="table detail_table"><thead  class="detail_table_bg"><tr><th>Size</th><th>S</th><th>M</th><th>L</th><th>XL</th></tr></thead><tbody><tr><td>Men</td><td>7-10</td><td>10-13</td><td>13-15</td><td>15-17</td></tr><tr><td>Women</td><td>7-9</td><td>10-12</td><td>13-14</td><td>15-16</td></tr></tbody></table>'),
(7, 'U.S. Polo Assn. Full Sleeve Plain T-Shirts for Men', 'sfdf', 8, 1800, 9, 15, 1, 'Shop for latest styles from our wide range of collection', 'Shop for latest styles from our wide range of collection', 'Shop for latest styles from our wide range of collection', 'Shop for latest styles from our wide range of collection', '<table class="table detail_table"><thead  class="detail_table_bg"><tr><th>Size</th><th>S</th><th>M</th><th>L</th><th>XL</th></tr></thead><tbody><tr><td>Men</td><td>7-10</td><td>10-13</td><td>13-15</td><td>15-17</td></tr><tr><td>Women</td><td>7-9</td><td>10-12</td><td>13-14</td><td>15-16</td></tr></tbody></table>'),
(8, 'U.S. Polo Assn. Full Sleeve Plain T-Shirts for Men', 'dffdf', 8, 3000, 3, 16, 1, 'Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry''s standard dummy text ever since the 1500s', 'Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry''s standard dummy text ever since the 1500s', 'Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry''s standard dummy text ever since the 1500s', 'Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry''s standard dummy text ever since the 1500s', '<table class="table detail_table"><thead  class="detail_table_bg"><tr><th>Size</th><th>S</th><th>M</th><th>L</th><th>XL</th></tr></thead><tbody><tr><td>Men</td><td>7-10</td><td>10-13</td><td>13-15</td><td>15-17</td></tr><tr><td>Women</td><td>7-9</td><td>10-12</td><td>13-14</td><td>15-16</td></tr></tbody></table>'),
(9, 'U.S. Polo Assn. Full Sleeve Plain T-Shirts for Men', 'dfdf', 2, 3500, 3, 17, 1, 'Jens is a male given name and a Danish, Norwegian, Swedish, Faroese and Frisian derivative of Johannes.', 'Jens is a male given name and a Danish, Norwegian, Swedish, Faroese and Frisian derivative of Johannes.', 'Jens is a male given name and a Danish, Norwegian, Swedish, Faroese and Frisian derivative of Johannes.', 'Jens is a male given name and a Danish, Norwegian, Swedish, Faroese and Frisian derivative of Johannes.', '<table class="table detail_table"><thead  class="detail_table_bg"><tr><th>Size</th><th>S</th><th>M</th><th>L</th><th>XL</th></tr></thead><tbody><tr><td>Men</td><td>7-10</td><td>10-13</td><td>13-15</td><td>15-17</td></tr><tr><td>Women</td><td>7-9</td><td>10-12</td><td>13-14</td><td>15-16</td></tr></tbody></table>'),
(10, 'U.S. Polo Assn. Full Sleeve Plain T-Shirts for Men', 'sdsdsddf', 3, 1500, 0, 18, 0, 'Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry''s standard dummy text ever since the 1500s', 'Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry''s standard dummy text ever since the 1500s', 'Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry''s standard dummy text ever since the 1500s', 'Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry''s standard dummy text ever since the 1500s', '<table class="table detail_table"><thead  class="detail_table_bg"><tr><th>Size</th><th>S</th><th>M</th><th>L</th><th>XL</th></tr></thead><tbody><tr><td>Men</td><td>7-10</td><td>10-13</td><td>13-15</td><td>15-17</td></tr><tr><td>Women</td><td>7-9</td><td>10-12</td><td>13-14</td><td>15-16</td></tr></tbody></table>'),
(11, 'U.S. Polo Assn. Full Sleeve Plain T-Shirts for Men', 'dfqw', 5, 2000, 4, 12, 0, 'Buy Chinos Online - Buy the latest collection of chinos @ Myntra. Huge range of chinos trousers for men & women', 'Buy Chinos Online - Buy the latest collection of chinos @ Myntra. Huge range of chinos trousers for men & women', 'Buy Chinos Online - Buy the latest collection of chinos @ Myntra. Huge range of chinos trousers for men & women', 'Buy Chinos Online - Buy the latest collection of chinos @ Myntra. Huge range of chinos trousers for men & women', '<table class="table detail_table"><thead  class="detail_table_bg"><tr><th>Size</th><th>S</th><th>M</th><th>L</th><th>XL</th></tr></thead><tbody><tr><td>Men</td><td>7-10</td><td>10-13</td><td>13-15</td><td>15-17</td></tr><tr><td>Women</td><td>7-9</td><td>10-12</td><td>13-14</td><td>15-16</td></tr></tbody></table>'),
(12, 'U.S. Polo Assn. Full Sleeve Plain T-Shirts for Men', 'qwery', 6, 8000, 8, 13, 0, 'Blazers Online. Buy latest designer blazers for men and women online in India. Shop for black blazers, brown blazers,', 'Blazers Online. Buy latest designer blazers for men and women online in India. Shop for black blazers, brown blazers,', 'Blazers Online. Buy latest designer blazers for men and women online in India. Shop for black blazers, brown blazers,', 'Blazers Online. Buy latest designer blazers for men and women online in India. Shop for black blazers, brown blazers,', '<table class="table detail_table"><thead  class="detail_table_bg"><tr><th>Size</th><th>S</th><th>M</th><th>L</th><th>XL</th></tr></thead><tbody><tr><td>Men</td><td>7-10</td><td>10-13</td><td>13-15</td><td>15-17</td></tr><tr><td>Women</td><td>7-9</td><td>10-12</td><td>13-14</td><td>15-16</td></tr></tbody></table>'),
(13, 'U.S. Polo Assn. Full Sleeve Plain T-Shirts for Men', 'zxcvb', 7, 700, 4, 16, 0, 'Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry''s standard dummy text ever since the 1500s', 'Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry''s standard dummy text ever since the 1500s', 'Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry''s standard dummy text ever since the 1500s', 'Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry''s standard dummy text ever since the 1500s', '<table class="table detail_table"><thead  class="detail_table_bg"><tr><th>Size</th><th>S</th><th>M</th><th>L</th><th>XL</th></tr></thead><tbody><tr><td>Men</td><td>7-10</td><td>10-13</td><td>13-15</td><td>15-17</td></tr><tr><td>Women</td><td>7-9</td><td>10-12</td><td>13-14</td><td>15-16</td></tr></tbody></table>');
...
INSERT INTO `item_attributes` (`id`, `name`) VALUES
(1, 'Size\r\n'),
(2, 'Color\r\n');
...
INSERT INTO `item_images` (`id`, `item_id`, `item_images_url`, `is_primary`) VALUES
(4, 1, 'new-thumb-01', 1),
(7, 2, 'new-thumb-02', 1),
(8, 3, 'new-thumb-03', 1),
(9, 4, 'new-thumb-04', 1),
...
(13, 8, 'new-thumb-08', 1),
(14, 9, 'new-thumb-01', 1),
(15, 10, 'new-thumb-02', 1),
(16, 11, 'new-thumb-03', 1),
(17, 12, 'new-thumb-04', 0),
(18, 13, 'new-thumb-05', 1),
(19, 1, 'new-thumb-01', 0);
...
INSERT INTO `item_options` (`id`, `item_id`, `ao_id`) VALUES
(1, 1, 3),
(2, 10, 4),
(3, 1, 5),
(4, 9, 6),
...
INSERT INTO `item_review` (`id`, `user_id`, `item_id`, `review_text`, `ratings`, `review_date`) VALUES
(1, 1, 2, 'it design is very nice', 4, '2018-02-02 08:08:45'),
(2, 3, 2, 'nice design', 5, '2018-02-02 08:09:23'),
(3, 1, 4, 'nice one', 4, '2018-02-02 10:29:53'),
(4, 4, 9, 'nice', 6, '2018-02-05 08:36:16'),
(5, 6, 13, 'sfd', 3, '2018-02-05 08:40:15'),
(6, 48, 1, 'lhh', 3, '2018-03-01 06:39:55'),
(7, 48, 2, 'sdfdf', 2, '2018-03-01 06:41:24'),
(8, 48, 10, 'sdsd', 2, '2018-03-01 06:42:01'),
(9, 48, 3, 'Nice', 3, '2018-03-01 07:35:00'),
(10, 48, 4, 'fgh', 3, '2018-03-01 07:35:51'),
(13, 48, 5, 'fgfgf', 3, '2018-03-01 07:38:13'),
(14, 47, 1, 'JJJJJJ', 3, '2018-03-05 03:25:49'),
(15, 47, 2, 'DFDF', 3, '2018-03-05 03:54:31'),
(16, 47, 3, 'FGFG', 3, '2018-03-08 11:11:54'),
(17, 47, 10, 'SHKA', 3, '2018-03-08 11:20:06'),
(18, 47, 11, 'DFG', 3, '2018-03-08 11:23:18'),
(19, 47, 13, 'FG', 3, '2018-03-08 11:24:26'),
(20, 47, 6, 'GH', 3, '2018-03-08 11:25:36'),
(21, 33, 2, 'FGH', 4, '2018-03-08 11:30:59'),
(22, 33, 3, 'DF', 3, '2018-03-08 11:32:31'),
(23, 48, 6, 'FGFG', 3, '2018-03-08 12:12:36'),
(25, 48, 7, 'FFFFFF', 3, '2018-03-08 12:15:02'),
(26, 48, 8, 'SD', 4, '2018-03-08 12:15:44');
...
(6, 'a@aa.in'),
(7, 's@ss.in'),
(10, 'harsh.chauhan@internal.mail'),
(19, 'yash.patel@internal.mail'),
(28, 'SDSDAS#DF@DFDF'),
(29, 'harshil.suvagiya@internal.mail');
...
INSERT INTO `testimonial` (`id`, `name`, `testimonial`) VALUES
(1, 'User 1', 'First - lorem ipsum suffered alteration in aome from, by injected humor , or randomized words which don''t look even slightly believable.There are many varation of passenger randomized words which don''t look even slightly believable'),
(2, 'User 2', 'Second - lorem ipsum suffered alteration in aome from, by injected humor , or randomized words which don''t look even slightly believable.There are many varation of passenger randomized words which don''t look even slightly believable"'),
(3, 'User 3', 'Third - lorem ipsum suffered alteration in aome from, by injected humor , or randomized words which don''t look even slightly believable.There are many varation of passenger randomized words which don''t look even slightly believable"'),
(4, 'User 4', 'Fourth - lorem ipsum suffered alteration in aome from, by injected humor , or randomized words which don''t look even slightly believable.There are many varation of passenger randomized words which don''t look even slightly believable"');
...
CREATE TABLE IF NOT EXISTS `user` (
  ...
  `shipping_add_id` int(11) DEFAULT NULL,
  `billing_add_id` int(11) DEFAULT NULL,
  `is_active` tinyint(4) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `shipping_add_id` (`shipping_add_id`),
  KEY `billing_add_id` (`billing_add_id`)
...
INSERT INTO `user` (`id`, `username`, `password`, `firstname`, `lastname`, `gender`, `email`, `mobile_number`, `phone_number`, `shipping_add_id`, `billing_add_id`, `is_active`) VALUES
(1, 'harshil', '982d324c31284025fb8ad1ca255a228b', 'har', 'suvagiya', '0', 'harshilsvg@gmail.com', '99240436', '9825941', 1, 2, 1),
(3, 'meet', 'd5f232e8dd6dc20e118d7b07bd450e39', 'meet', 'joshi', '0', 'meetjoshi@server1.com', '9854628025', '9868451252', 2, 1, 1),
(4, 'raj', 'b24484c2f59425ff4c0f371153f0df69', 'raj', 'desai', '0', 'rajdeshai@server1.com', '9752648157', '9425934187', 3, 3, 1),
(5, 'parth', '1592f4a6f03dfdf4dca29de2a7874507', 'parth', 'mehta', '0', 'parthmaheta@gmail.com', '7925698843', '9468547898', 4, 4, 1),
(6, 'manan', '462d9ff7dc93970fd3aa8a408a87a5b9\n', 'manan', 'shah', '0', 'manan@gmail.com', '9924043669', '9853725840', 5, 5, 1),
(30, 'harshilsvg', '1f2003a5f77a5c21ae6769e39be0da78', 'fg', 'svgfg', '0', 'fgfg', '10', '10', 14, 15, 0),
(33, 'ankit_ranpariya', 'c6683ef3a21f11e23e54dd12e3da5fb5', 'ankit', 'ranpariya', '0', 'ankit@gmail.com', '(555) 555-4444', '222333', 24, 25, 0),
(34, 'parth mehta', '73d5af308dc96cc9a9698307b6918df1', 'parth', 'mehta', '0', 'parth@gmail.com', '(555) 555-4444', '112123', 22, 23, 0),
(38, 'meet_joshi', '57ec448046f8d26676f64d477cc161a2', 'meet', 'joshi ', '0', 'meet@gmail.com', '9854043894', '9560152332', 20, 21, 0),
(39, 'manan_vekariya', '1e3b04fb223bf72983c5b719944fca5f', 'manan', 'vekariya', '0', 'manan123@gmail.com', '7925689410', '112', 16, 17, 0),
(40, 'aaaaaaaaaaaa', '1f2003a5f77a5c21ae6769e39be0da78', 'sa', 's', '0', 'a@aa.in', '(555) 555-1234', '112', NULL, NULL, 0),
(47, 'raj_mehta', 'b24484c2f59425ff4c0f371153f0df69', 'raj', 'mehta', '0', 'raj@gmail.com', '9992945445', '121', 18, 19, 0),
(48, 'harshilsuvagiya', '1f2003a5f77a5c21ae6769e39be0da78', 'HARSHIL', 'SUVAGIYA', '0', 'harshilsvg1997@gmail.com', '9924043669', '222459', 26, 27, 1),
(81, 'ADITI123', 'c294d0f712359b0dd8ce630b1d271181', 'SD', 'raval', '1', 'adity@gmail.com', '1054548565', '1010101010', 30, 31, 1),
(115, 'akshay_ranpariya', 'b5f9a2a4e346bd1cc350e86c693dc53c', 'akshay', 'ranpariya', '0', 'akshay@gmail.com', '9924043669', '1010101010', 30, 25, 1);
...
ALTER TABLE `attributes_options`
  ADD CONSTRAINT `ao_item_attributes` FOREIGN KEY (`attribute_id`) REFERENCES `item_attributes` (`id`);

--
-- Constraints for table `item`
--
ALTER TABLE `item`
  ADD CONSTRAINT `item_category` FOREIGN KEY (`category_id`) REFERENCES `category` (`id`);

--
-- Constraints for table `item_images`
--
ALTER TABLE `item_images`
  ADD CONSTRAINT `item_images_item` FOREIGN KEY (`item_id`) REFERENCES `item` (`id`);

--
-- Constraints for table `item_options`
--
ALTER TABLE `item_options`
  ADD CONSTRAINT `a_o` FOREIGN KEY (`ao_id`) REFERENCES `attributes_options` (`id`),
  ADD CONSTRAINT `item_options_item` FOREIGN KEY (`item_id`) REFERENCES `item` (`id`);

--
-- Constraints for table `item_review`
--
ALTER TABLE `item_review`
  ADD CONSTRAINT `item_review_item` FOREIGN KEY (`item_id`) REFERENCES `item` (`id`),
  ADD CONSTRAINT `item_review_user` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`);

--
-- Constraints for table `state`
--
ALTER TABLE `state`
  ADD CONSTRAINT `state_country` FOREIGN KEY (`country_id`) REFERENCES `country` (`id`);

--
-- Constraints for table `user`
--
ALTER TABLE `user`
  ADD CONSTRAINT `billing_user_address` FOREIGN KEY (`billing_add_id`) REFERENCES `address` (`id`),
  ADD CONSTRAINT `shipping_user_address` FOREIGN KEY (`shipping_add_id`) REFERENCES `address` (`id`);

--
-- Constraints for table `wishlist`
--
ALTER TABLE `wishlist`
  ADD CONSTRAINT `wishlist_item` FOREIGN KEY (`item_id`) REFERENCES `item` (`id`),
  ADD CONSTRAINT `wishlist_user` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`);
